...
export const TYPERT = {
  ...
  schemas: [{ name: 'WhaleBoundaryFrame', create: () => WHALE_FRAME_SCHEMA }],
  ...
  model: {
    services: [{
      ...
      members: [{ kind: 'method', name: 'watch', signature: 'watch(signal: AbortSignal): AsyncIterable<WhaleBoundaryFrame>' }],
      types: [],
    }],
    events: [], objects: [],
  },
